...
1. [Chapter I](#chapter-i) \
   1.1 [Installation of the OS](#part-1-installation-of-the-os)  
   1.2 [Creating a user](#part-2-creating-a-user)  
   1.3 [Setting up the OS network](#part-3-setting-up-the-os-network)   
   1.4 [OS Update](#part-4-os-update)  
   1.5 [Using the sudo command](#part-5-using-the-sudo-command)  
   1.6 [Installing and configuring the time service](#part-6-installing-and-configuring-the-time-service)  
   1.7 [Installing and using text editors](#part-7-installing-and-using-text-editors)  
   1.8 [Installing and basic setup of SSHD service](#part-8-installing-and-basic-setup-of-the-sshd-service)  
   1.9 [Installing and using the top, htop utilities](#part-9-installing-and-using-the-top-htop-utilities)   
   1.10 [Using the fdisk utility](#part-10-using-the-fdisk-utility)   
   1.11 [Using the df utility](#part-11-using-the-df-utility)    
   1.12 [Using the du utility](#part-12-using-the-du-utility)    
   1.13 [Installing and using the ncdu utility](#part-13-installing-and-using-the-ncdu-utility)    
   1.14 [Working with system logs](#part-14-working-with-system-logs)     
   1.15 [Using the CRON job scheduler](#part-15-using-the-cron-job-scheduler)


## Chapter I

As a result of the work should provide a report with completed tasks. Each part of the task describe what should be added to the report once it has been completed. This can be screenshots, some data, etc.
